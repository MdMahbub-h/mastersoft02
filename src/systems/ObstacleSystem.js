...
class ObstacleSystem {
  constructor(scene, gameState) {
    ...
    this.types = {
      tree: { sprite: "tree", scale: 1, damage: 25, density: 1 },
      rock: { sprite: "rock", scale: 1, damage: 35, density: 1 },
      missile: { sprite: "missile", scale: 1, damage: 50, density: 1 },
      steel: { sprite: "steel", scale: 1, damage: 50, density: 1 },
      building: { sprite: "building", scale: 1, damage: 50, density: 1 },
    };
  }
